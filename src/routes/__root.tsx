  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold text-gradient-emergency">404</h1>
        <p className="mt-4 text-muted-foreground">Signal lost. The page you're looking for is offline.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SENTINEL — IoT Accident Response Command Center" },
      { name: "description", content: "Real-time IoT accident monitoring and emergency dispatch dashboard." },
    ],
    links: [
